...
import {
    Globe, Users, TrendingUp, Zap, Clock, Shield, ArrowRight, CheckCircle2,
    Award, FileText, BarChart3, DollarSign
} from 'lucide-react';
...
const features = [
    {
        ...
        description: 'Multi-country tax compliance, transfer pricing, international expansion support.',
        color: 'text-blue-500',
        bg: 'bg-blue-500/10',
    },
    {
        ...
        description: 'Grow your business with our flexible, scalable accounting infrastructure.',
        color: 'text-gold-500',
        bg: 'bg-gold-500/10',
    },
    {
        ...
        description: 'Live dashboards, consolidated reporting, and instant financial visibility.',
    ...
    },
    {
        ...
        description: 'ISO 27001 certified, SOC 2 compliant, dedicated security protocols.',
        color: 'text-rose-500',
        bg: 'bg-rose-500/10',
    },
    {
        icon: Clock,
        title: '24/7 Support',
        description: 'Global support team across time zones, always available when you need us.',
        color: 'text-cyan-500',
        bg: 'bg-cyan-500/10',
    },
    {
        ...
        description: 'CPA, CA, CMA professionals with multinational accounting experience.',
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="animate-fade-up">
                        ...
                        <p className="text-lg text-white/70 max-w-2xl mb-8 leading-relaxed">
                            Comprehensive accounting and tax services for multinational corporations. Navigate global compliance, optimize tax positions, and achieve financial clarity across all operations.
                        </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16 reveal">
                        <h2 className="font-display text-4xl md:text-5xl font-bold text-slate-900 mb-5">
                            ...
                            <span className="gradient-text-blue">Global Operations</span>
                        </h2>
                        <p className="text-lg text-slate-500 max-w-2xl mx-auto">
                            Trusted by multinational enterprises to handle complex international accounting needs.
                        </p>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {services.map((service) => {
                            ...
                            return (
                                <div key={service.name} className="bg-white rounded-2xl p-7 border border-slate-100 shadow-card hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1">
            ...
            <section className="py-24 bg-primary-900 relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
                    ...
                    <p className="text-lg text-white/60 max-w-2xl mx-auto mb-8">
                        Let our global team handle your accounting complexity while you focus on growth.
                    </p>
